...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section id="top" className="relative w-full min-h-[600px] lg:min-h-[700px] flex flex-col items-center justify-between px-4 sm:px-8 lg:px-[75px] py-6 lg:py-[29px]">
        {/* Background Image */}
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row items-start lg:items-end justify-between gap-8 lg:gap-12 mt-auto">
          ...
          <nav className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 lg:gap-[50px] w-full sm:w-auto">
            <a href="#intro" className="text-base sm:text-lg lg:text-xl text-black hover:opacity-70 transition-opacity whitespace-nowrap font-['Roboto']">
              Sold Out Studio 소개
            </a>
            <a href="#portfolio" className="text-base sm:text-lg lg:text-xl text-black hover:opacity-70 transition-opacity font-['Roboto']">
              Portfolio
            </a>
            <a href="#contact" className="text-base sm:text-lg lg:text-xl text-black hover:opacity-70 transition-opacity font-['Roboto']">
              Contact
            </a>
          </nav>
        </div>
      ...
      <section id="intro" className="relative w-full min-h-[600px] lg:min-h-[700px] bg-white px-4 sm:px-8 lg:px-[75px] py-12 lg:py-[91px]">
        <div className="max-w-[1440px] mx-auto relative">
          ...
          <div className="lg:ml-auto lg:max-w-[911px] flex flex-col gap-8 lg:gap-[102px]">
            ...
            <h2 className="text-xl sm:text-2xl lg:text-[24px] text-[#191919] leading-normal font-noto-kr">
              <span className="text-3xl sm:text-4xl lg:text-[48px] font-continuous">Sold Out Studio</span>
              <span className="text-xl sm:text-2xl lg:text-[24px]">는 </span>
              <span className="text-xl sm:text-2xl lg:text-[26px] font-semibold">합리적인 비용</span>
              <span className="text-xl sm:text-2xl lg:text-[24px]">으로 </span>
              <span className="text-xl sm:text-2xl lg:text-[26px] font-semibold">최고의 결과물</span>
              <span className="text-xl sm:text-2xl lg:text-[24px]">을 만드는 영상 편집 스튜디오입니다.</span>
            </h2>
            ...
            <div className="flex flex-col gap-8 lg:gap-[60px]">
              ...
              <div className="flex items-start gap-4 lg:gap-[28px]">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl text-[#191919] leading-normal font-noto-kr">
                  불필요한 요소는 줄이고, 필요한 디테일에 집중해 가격 이상의 퀄리티를 제공합니다.
                </p>
              </div>
      ...
      <section 
        ...
        style={{ backgroundImage: "url('https://api.builder.io/api/v1/image/assets/TEMP/2a703e35987c2edce654ee0142011ca51b74635f?width=2880')" }}
      >
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="mb-8 lg:mb-12">
            ...
            <p className="text-xl sm:text-2xl lg:text-[32px] text-[#191919] leading-normal font-noto-kr">
              유튜브, 기업, 관공서, 홍보, 광고 영상 등 클라이언트 <span className="text-2xl sm:text-3xl lg:text-[36px] font-semibold">맞춤형</span> 영상 제작 <span className="text-xl sm:text-2xl lg:text-[32px]">가능</span>
            </p>
          </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="relative w-full min-h-[800px] lg:min-h-[1061px] bg-white px-4 sm:px-8 lg:px-[98px] py-12 lg:py-[96px]">
        <div className="max-w-[1440px] mx-auto relative">
              ...
              <div className="relative">
                ...
                <div className="space-y-4 lg:space-y-6">
                  ...
                  <p className="text-lg sm:text-xl lg:text-2xl text-black font-['Roboto'] leading-normal">
                    ※ 문자로 연락처, 성함 및 상담 내용을 간단하게 남겨주시면 바로 연락드리겠습니다.
                  </p>
                  <p className="text-lg sm:text-xl lg:text-2xl text-black font-['Roboto']">
                ...
                {/* Divider */}
                <svg className="hidden lg:block absolute -left-[180px] top-[70px]" width="7" height="346" viewBox="0 0 7 346" fill="none">
                  <path d="M1.5 0.0175781L5.5 345.018" stroke="#191919" strokeWidth="3"/>
                </svg>
              </div>
            </div>
          </div>
